...
gRosClasses["PowerboardGraphWidget"] = function(dom){
  return new PowerboardGraphWidget(dom);
}
...
gRosClasses["PowerboardGraph2Widget"] = function(dom){
  return new PowerboardGraph2Widget(dom);
}
...
gRosClasses["PowerboardGraph3Widget"] = function(dom){
  return new PowerboardGraph3Widget(dom);
}
...
gRosClasses["PowerboardWidget"] = function(dom){
  return new PowerboardWidget(dom);
}
...
gRosClasses["BatteryGauge"] = function(dom){
  return new BatteryGauge(dom);
}

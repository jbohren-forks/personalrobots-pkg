...
class MoveHeadState(roslib.message.Message):
  _md5sum = "42f188c09f43b7b9c1dfd7b8285de0d7"
  _type = "follower/MoveHeadState"
...
"""
  ...
  _slot_types = ['Header','robot_actions/ActionStatus','follower/MoveHeadGoal','std_msgs/Empty']
  ...
  def __init__(self, *args, **kwds):
    ...
    if self.goal is None:
      self.goal = follower.msg.MoveHeadGoal()

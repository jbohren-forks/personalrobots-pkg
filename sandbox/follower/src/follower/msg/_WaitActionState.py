...
class WaitActionState(roslib.message.Message):
  _md5sum = "3da8cfb44ffcd3ffb1b26035cdd0dbb5"
  _type = "follower/WaitActionState"
...
"""
  ...
  _slot_types = ['Header','robot_actions/ActionStatus','follower/WaitActionGoal','std_msgs/Empty']
  ...
  def __init__(self, *args, **kwds):
    ...
    if self.goal is None:
      self.goal = follower.msg.WaitActionGoal()

# autogenerated by genmsg_py from WaitActionState.msg. Do not edit.
...
class WaitActionState(roslib.message.Message):
  _md5sum = "dbe318df45127eae6cfcd22e02e477bf"
  _type = "annotated_map_builder/WaitActionState"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """Header header
robot_actions/ActionStatus status
annotated_map_builder/WaitActionGoal goal
...
string comment
================================================================================
MSG: annotated_map_builder/WaitActionGoal
int32 num_events
string topic_name
...
"""
  ...
  _slot_types = ['Header','robot_actions/ActionStatus','annotated_map_builder/WaitActionGoal','std_msgs/Empty']
  ...
  def __init__(self, *args, **kwds):
    super(WaitActionState, self).__init__(*args, **kwds)
    ...
    if self.goal is None:
      self.goal = annotated_map_builder.msg.WaitActionGoal()
    if self.feedback is None:
      self.feedback = std_msgs.msg.Empty()

  ## internal API method
  def _get_types(self): return WaitActionState._slot_types
  ...
  def serialize(self, buff):
    try:
      ...
      buff.write(struct.pack('<i', self.goal.num_events))
      length = len(self.goal.topic_name)
      #serialize self.goal.topic_name
      buff.write(struct.pack('<I%ss'%length, length, self.goal.topic_name))
  ...
  def deserialize(self, str):
    try:
      ...
      (self.goal.num_events,) = struct.unpack('<i',str[start:end])
      start = end
      end += 4
      (length,) = struct.unpack('<I',str[start:end])
      #deserialize self.goal.topic_name
      pattern = '<%ss'%length
      start = end
      end += struct.calcsize(pattern)
      (self.goal.topic_name,) = struct.unpack(pattern, str[start:end])
      return self

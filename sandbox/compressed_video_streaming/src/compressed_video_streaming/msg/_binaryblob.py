# autogenerated by genmsg_py from binaryblob.msg. Do not edit.
import roslib.message
import struct

## \htmlinclude binaryblob.msg.html

class binaryblob(roslib.message.Message):
  _md5sum = "686a5a6faa4b2c7d2070ef2a260d09e7"
  _type = "compressed_video_streaming/binaryblob"
...
"""
  ...
  def __init__(self, *args, **kwds):
    super(binaryblob, self).__init__(*args, **kwds)
    #message fields cannot be None, assign default values for those that are
    if self.blob is None:
      self.blob = ''

  ## internal API method
  def _get_types(self): return binaryblob._slot_types

...
macro(gencfg_cpp)
  ...
  foreach(_cfg ${_cfglist})
    ...
    set(_output_msg ${PROJECT_SOURCE_DIR}/msg/${_cfg}Config.msg)
    set(_output_getsrv ${PROJECT_SOURCE_DIR}/msg/Get${_cfg}Config.srv)
    set(_output_setsrv ${PROJECT_SOURCE_DIR}/msg/Set${_cfg}Config.srv)
    set(_output_dox ${PROJECT_SOURCE_DIR}/dox/${_cfg}Config.dox)

...
namespace TREX{
  ...
  public:
    Watchdog(): ros::Node("trex_watch_dog"), watchdogOK_(true), watchdogTimeLimit_(1.0){
      param("executive/ping_frequency", watchdogTimeLimit_, watchdogTimeLimit_);
      subscribe<highlevel_controllers::Ping>("executive/ping", pingMsg_, &Watchdog::pingCallback, 1);

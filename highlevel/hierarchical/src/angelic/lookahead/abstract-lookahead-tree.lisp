	     ...
	     (let ((e (parent-edge n2)))
		   ...
		   (if e
		       (let* ((n1l (tail e))
			      ...
			      (cs (complete-set n1l)))
			 (cond ((and (sound-set n2l) (not (set-eq (sound-set n2l) (sound-reachable-set a ss hpp)))) 'sound-reachable)
			       ((and (complete-set n2l) (not (set-eq (complete-set n2l) (complete-reachable-set a cs hpp)))) 'complete-reachable)

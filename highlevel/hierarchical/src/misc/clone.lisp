...
;;
;; DEPRECATED
;; I now think that it is not really possible to define such
;; a function cleanly without knowing in what context it will be used.  So ideally, this should be
;; replaced by separate functions for each context (e.g., clone-q-function, clone-tree)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
")
  (:method (x) (error "Don't know how to clone object ~a" x)))
...
(defmethod clone ((x function)) ;; TODO: really need to get rid of clone
  x)

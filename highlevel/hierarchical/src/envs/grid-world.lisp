...
(defun unif-grid-dist-sampler (gw)
...
;;
(defun noisy-move-dist (gw l a msp)
...
(defgeneric loc-value (gw l)
  (:documentation "return value of this location.  Assumes location is valid."))

(defmethod loc-value ((gw <grid-world>) l)
  (apply #'aref (world-map gw) l))


(defgeneric world-map (gw)
  (:documentation "World map of this grid world.  A 2d array."))

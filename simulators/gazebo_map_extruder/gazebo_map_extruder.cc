...
int create_gazebo_obstacles(const char* fname, int width, int height,
                            rect_t* rects, 
                            unsigned int rect_count,
                            double res);
...
main(int argc, char** argv)
{
  ...
  create_gazebo_obstacles(infile, width, height,
                          rects, 
                          rect_count,
                          res);
...
int
create_gazebo_obstacles(const char* filename,
                        int width,
                        int height,
                        rect_t* rects, 
                        unsigned int rect_count,
                        double res)
{
  printf("<?xml version=\"1.0\"?>\n"
         "<!-- This file autogenerated by gazebo_map_extruder by parsing %s -->\n"
  ...
  *rects = (rect_t*)malloc(sizeof(rect_t)*rects_allocated);
  ...
  for(y = 0; y < img_height; y++)
  {
    for(x = 0; x < img_width; x++)
    {
      ...
      set_rect(img, startx, starty, x-startx, height, 0xFF);

#!/bin/bash
export GAZ_TOP=`rospack find gazebo`/gazebo-git
...
export LD_LIBRARY_PATH=$GAZ_TOP/root/lib:$LD_LIBRARY_PATH
export PATH=$GAZ_TOP/root/bin:$PATH

export GAZEBO_RESOURCE_PATH=$PR2MEDIA
export OGRE_RESOURCE_PATH=$GAZ_TOP/root/lib/OGRE

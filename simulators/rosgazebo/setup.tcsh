#!/bin/tcsh
setenv GAZ_TOP `rospack find gazebo`/gazebo-git
...
setenv LD_LIBRARY_PATH $GAZ_TOP/root/lib:$LD_LIBRARY_PATH
setenv PATH $GAZ_TOP/root/bin:$PATH

setenv GAZEBO_RESOURCE_PATH $PR2MEDIA
setenv OGRE_RESOURCE_PATH $GAZ_TOP/root/lib/OGRE

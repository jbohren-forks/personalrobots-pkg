...
// Our node
class RosGazeboControlsNode : public ros::node
{
  private:
  ...
  public:
    ...
    RosGazeboControlsNode(int argc, char** argv, const char* fname,
         PR2::PR2Robot          *myPR2,
   ...
   // Constructor; stage itself needs argc/argv.  fname is the .world file
    ...
    void cmd_leftposeReceived();
    void cmd_rightposeReceived();
    ...
    rosgazebo::CartesianCmd cmd_rightpose;

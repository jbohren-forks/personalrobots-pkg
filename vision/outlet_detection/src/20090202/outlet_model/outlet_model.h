...
void detect_outlets(IplImage* src, vector<outlet_feature_t>& features, vector<outlet_t>& outlets, const char* filename = 0);
...
int select_orient_outlets(IplImage* grey, vector<outlet_t>& outlets, const char* filename = 0);
...
int filter_outlets_templmatch(IplImage* src, vector<outlet_t>& outlets, const char* filename = 0, 
							  CvMat** homography = 0, CvPoint3D32f* origin = 0, CvPoint2D32f* scale = 0);

...
#convert a numpy matrix to a python imaging library image
def numpymat2pilimage(nmat):
	return Image.fromstring('L',(mat.shape[0],m.shape[1]),m.tostring())

##convert a pil image to a pygame image
#def pilimage2pygameimage(pimage):
#	img = pimage.convert("RGB")
#	return pygame.image.fromstring(img.tostring(),(pimage.size[0],pimage.size[1]),"RGB")

# -*- coding: utf-8 -*-
#
# stereo_utils documentation build configuration file, created by
...
htmlhelp_basename = 'stereo_utilsdoc'
...
latex_documents = [
  ('index', 'stereo_utils.tex', u'stereo\\_utils Documentation',

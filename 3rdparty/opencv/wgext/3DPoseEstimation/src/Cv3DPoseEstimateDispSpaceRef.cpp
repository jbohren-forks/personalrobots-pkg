...
int Cv3DPoseEstimateDispSpaceRef::estimateMixedPointClouds_old(
	...
	numInLiers = estimate_old(xyzs0, xyzs1, uvds0, uvds1, 
...
int Cv3DPoseEstimateDispSpaceRef::estimate_old(CvMat *xyzs0, CvMat *xyzs1,

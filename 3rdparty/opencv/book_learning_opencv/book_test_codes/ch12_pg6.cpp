//Call: birdseye board_w board_h instrinics distortion image_file
...
int main(int argc, char* argv[]) {
    ...
    cvInitUndistortMap(  //This initializes rectification matrices
      intrinsic,
      distortion,
      mapx,
      mapy
    ...
    cvRemap( t, image, mapx, mapy );   //Rectify our image
    ...
    while(key != 27) {  //escape key stops
       CV_MAT_ELEM(*H,float,2,2) = Z; //Set the height

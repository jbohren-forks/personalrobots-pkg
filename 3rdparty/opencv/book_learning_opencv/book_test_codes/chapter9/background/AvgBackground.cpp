//
//  in the first section, declaring IavgF, IdiffF, the book leaves out [NUM_CAMERAS], assuming 1 camera?
//
//  where is setHighThreshold(float scale) and
//  where is setLowThreshold(float scale) ??? on page 10
//
//
